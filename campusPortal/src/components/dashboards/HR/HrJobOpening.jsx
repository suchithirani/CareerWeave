...
const Pagination = ({ 
  ...
  return (
    <div className={`flex flex-col md:flex-row items-center justify-between ${className}`}>
      <div className="text-xs sm:text-sm text-gray-700 mb-4 md:mb-0">
      ...
      <div className="flex items-center space-x-1 sm:space-x-2">
        <button
          ...
          className="p-1 sm:p-2 rounded-lg border border-gray-300 text-gray-700 bg-white hover:bg-gray-50 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
...
const HrJobOpening = () => {
  ...
  const fetchJobOpenings = async () => {
    setLoading(true);
    try {
      const res = await api.get('/job-openings/HR');
  ...
  const handleSubmit = async (isEdit) => {
    if (!form.title || !form.location || !form.applicationDeadline) {
      return toast.error("Title, location, and deadline are required.");
    }
    ...
    try {
      ...
      toast.error(err.response?.data?.message || 'Failed to process job');
    }
  };
  ...
  const renderFormModal = ({ isEdit = false }) => (
    ...
    >
      <motion.div 
        initial={{ y: 20 }}
        animate={{ y: 0 }}
        className="bg-white p-4 sm:p-6 rounded-xl w-full max-w-2xl max-h-[90vh] overflow-y-auto"
      >
        <div className="flex justify-between items-center mb-4">
          <h3 className="text-lg sm:text-xl font-semibold">{isEdit ? 'Edit' : 'Create'} Job Opening</h3>
          <button 
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-3 sm:gap-4">
          <div className="space-y-1">
            ...
            <input 
              ...
              className="w-full border border-gray-300 rounded-lg px-3 py-2 text-xs sm:text-sm focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 outline-none" 
            />
          </div>
          ...
          <div className="space-y-1">
            <label className="block text-xs sm:text-sm font-medium text-gray-700">Salary (LPA)</label>
            <input 
              type="number" 
              name="salaryLPA" 
          ...
          <div className="space-y-1">
            <label className="block text-xs sm:text-sm font-medium text-gray-700">Eligibility Criteria</label>
            <input 
              type="text" 
        ...
        <div className="mt-4 sm:mt-6 flex justify-end space-x-2 sm:space-x-3">
          ...
          <motion.button
            ...
            disabled={!form.title || !form.location || !form.applicationDeadline}
            className={`px-3 sm:px-4 py-2 rounded-lg text-white transition-colors text-xs sm:text-sm ${
              (!form.title || !form.location || !form.applicationDeadline) 
                ...
                <div className="hidden sm:block overflow-x-auto">
                  <table className="min-w-full divide-y divide-gray-200">
                    <thead className="bg-gradient-to-r from-gray-50 to-blue-50">
                      <tr>
                        {['Title', 'Location', 'Status', 'Salary', 'Deadline', 'Actions'].map((header) => (
                          ...
                          >
                            ...
                            <td className="px-4 sm:px-6 py-4 whitespace-nowrap">
                              <div className="flex items-center">
                                ...
                                <span>{job.salaryLPA ? `${job.salaryLPA} LPA` : 'Not specified'}</span>
                              </div>
                            </td>
                            <td className="px-4 sm:px-6 py-4 whitespace-nowrap">
                              <div className="flex items-center">
                          ...
                          <div className="grid grid-cols-2 gap-4 mb-3">
                            <div>
                              ...
                              <p className="text-sm flex items-center">
                                ...
                                {job.salaryLPA ? `${job.salaryLPA} LPA` : 'Not specified'}
                              </p>
                            </div>
                            <div>
                            ...
                            <div>
                              ...
                              <p className="text-sm">
                                {job.eligibilityCriteria || 'Not specified'}
                              </p>
                            </div>
                          </div>
        ...
        <div className="p-8">
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <p className="text-gray-800 flex items-center">
                    ...
                    {viewJob.salaryLPA ? `${viewJob.salaryLPA} LPA` : 'Not specified'}
                  </p>
                </div>
              </div>
            </div>
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <p className="text-gray-800 flex items-center">
                    ...
                    {viewJob.eligibilityCriteria || 'Not specified'}
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="flex justify-end space-x-4 pt-6 border-t border-gray-200">
            <button
              ...
              className="px-6 py-2 bg-yellow-50 border border-yellow-200 rounded-xl text-yellow-700 hover:bg-yellow-100 transition-colors font-medium flex items-center"
            >
